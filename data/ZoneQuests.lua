...
local quests = {
    ...
    ["darkbrotherhood/anvilcity_base"] = {
        {
            id = 5540,
            xpos = 0.3223772054, -- Shar ??
            ypos = 0.5798740042, -- Shar ??
        },
        {
            id = 5544,
            xpos = 0.3281764055, -- Shar ??
            ypos = 0.5805760035, -- Shar ??
        },
        {
            id = 5546,
            xpos = 0.3291472058, -- Shar ??
            ypos = 0.5666816070, -- Shar ??
        },
    },
    ["darkbrotherhood/kvatchcity_base"] = {
        {
            id = 5541,
            xpos = 0.3659864003, -- Shar ??
            ypos = 0.5617652202, -- Shar ??
        },
    },
    ["darkbrotherhood/dbsanctuary_base"] = {
        {
            id = 5542,
            xpos = 0.3403867924, -- Shar ??
            ypos = 0.5497991989, -- Shar ??
        },
        {
            id = 5708,
            xpos = 0.3400691952, -- Shar ??
            ypos = 0.5502380005, -- Shar ??
        },
        {
            id = 5595,
            xpos = 0.3400715952, -- Shar ??
            ypos = 0.5502040003, -- Shar ??
        },
        {
            id = 5630,
            xpos = 0.3400627953, -- Shar ??
            ypos = 0.5502184004, -- Shar ??
        },
        {
            id = 5654,
            xpos = 0.3400575953, -- Shar ??
            ypos = 0.5502256004, -- Shar ??
        },
        {
            id = 5718,
            xpos = 0.3401283947, -- Shar ??
            ypos = 0.5499271993, -- Shar ??
        },
        {
            id = 5634,
            xpos = 0.3401167948, -- Shar ??
            ypos = 0.5499179993, -- Shar ??
        },
        {
            id = 5599,
            xpos = 0.3401391946, -- Shar ??
            ypos = 0.5502352005, -- Shar ??
        },
        {
            id = 5659,
            xpos = 0.3400595953, -- Shar ??
            ypos = 0.5502240004, -- Shar ??
        },
    },
}
